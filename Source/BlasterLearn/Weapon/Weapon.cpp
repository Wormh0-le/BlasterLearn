...
void AWeapon::BeginPlay()
{
	...
	// if (HasAuthority()) { equip weapon is server rpc, so
...
void AWeapon::Fire(const FVector& HitTarget)
{
	...
	// if (HasAuthority()) // use client prediction, otherwise ammo value have delay 
	// {
	SpendRound();	
	// }
}
...
FVector AWeapon::TraceEndWithScatter(const FVector& HitTarget)
{
	...
	DrawDebugSphere(GetWorld(), FVector(TraceStart + ToEndLoc * TRACE_LENGTH / ToEndLoc.Size()), 16.f, 12, FColor::Green, true);
